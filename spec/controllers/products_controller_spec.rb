...
describe ProductsController do
  ...
  let(:valid_attributes) { { title: Faker::Lorem.word, description: Faker::Lorem.paragraph, image_url: Faker::Company.logo, link: Faker::Internet.url, category: "Lesson Plan", kind: "test"  } }
